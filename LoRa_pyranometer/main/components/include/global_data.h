...
#include "esp_now.h"
    ...
    extern QueueHandle_t dsm_queue; // Cria um handler para a fila de recebimento de itens, marcado como "extern" para que o compilador saiba
                                    // que ela será inicializada por uma fonte externa.
#endif
