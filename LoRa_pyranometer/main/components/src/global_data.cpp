...
esp_err_t i2c_init()
{
    i2c_config_t i2c_config; // Changed how i2c_config is initialized to get rid of compiler warnings about uninitialized values
...
void snd_data_task(void *pvParameters)
{
    ...
    { // Verifica se o autojoin esta ativado, se nao estiver, o ativa
#ifdef SERIAL_DEBUG
    ...
    while (1)
    {
        ...
        {                                                                  // Se o contador for maior que a quantidade de contagem definida no header
